...
| HU-15 Recepción, revisión y autorización | **Parcial** | ✅ Turnado secuencial obligatorio corregido (residencia no puede resolver antes de `en_revision`). ✅ **Semáforo de 15 días ya visible** para supervisión/residencia en la carátula (mismo helper que HU-13). Sigue faltando: **revisión sección por sección** (carátula/generadores/fotos/soportes/notas) — las observaciones son un textarea libre único, sin tipo, severidad ni concepto asociado. Esto depende de que HU-12 capture esas secciones primero (fotos, soportes) — queda para cuando se aborde HU-12. |
