...
4. **HU-19 necesita XLSX/PDF real** (hoy todo es CSV) — ya existe `backend/src/utils/xlsxExport.js` (creado para HU-10) reutilizable para Excel; falta agregar `pdfkit` para los reportes que piden PDF. Siguiente candidato natural.
